...
We release the best model we obtained through training with data augmentation. Set path='experiments/all_no_aug_sd999_lr0.005_bs128_sp5_dc3' to evaluate it. 
